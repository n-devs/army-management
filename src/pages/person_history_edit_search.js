...
import MediaControlCardEdit from '../components/cards/MediaControlCardEdit';


export default function PersonHistoryEditSearch(props) {
                  ...
                  >
                        ...
                        <Grid item>
                              <Stack spacing={2}>
                                    ...
                                    <MediaControlCardEdit key={key} {...val} link={`/person-history-edit?id=${val.id}`}></MediaControlCardEdit>)}
