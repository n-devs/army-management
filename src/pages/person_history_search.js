...
import MediaControlCard from '../components/cards/MediaControlCard';


export default function PersonHistorySearch(props) {
                  ...
                  >
                        ...
                        <Grid item>
                              <Stack spacing={2}>
                                    ...
                                    <MediaControlCard key={key} {...val} link={`/person-history?id=${val.id}`}></MediaControlCard>)}
