...
export default function PersonHistoryAdd(props) {
      ...
      const updateData = (obj) => (e) => {
            ...
            if (obj.turns === "") {
                  ...
                  api.post('/api/employees', { ...obj })
                        .then(({ data }) => {
                              console.log('Success:', data);
                              setAlertMessage({
                                    open: true,
                                    message: "เพิ่มข้อมูลพลทหาร เสร็จสิ้น",
                                    severity: "success"
                              ...
                              <Paper square style={{
                                    ...
                                    >
                                          ...
                                          <Grid item style={{
                                                ...
                                                <Divider></Divider>
                                                <Button variant="contained" onClick={updateData(data)}>อัพเดตประวัติพลทหาร</Button>
