...
export default function PersonHistoryEdit(props) {
      ...
      const updateData = (obj) => (e) => {
            ...
            if (obj.turns === "") {
                  ...
                  api.put(`/api/employees/${obj.id}`, { ...obj })
                        .then(({ data }) => {
                              console.log('Success:', data);
                              setAlertMessage({
                                    open: true,
                                    message: "แก้ไขข้อมูลพลทหาร เสร็จสิ้น",
                                    severity: "success"
      ...
      React.useEffect(() => {
            api.get(`/api/employees${window.location.search}`).then((res) => {
                  ...
                  if (res.data.length !== 0) {
                        ...
                        window.location.replace(`/person-history-edit-search${window.location.search}`)
                        setData({ ...data })
                  }
            }).catch((err) => {
                  console.log(err);
                              ...
                              <Paper square style={{
                                    ...
                                    >
                                          ...
                                          <Grid item style={{
                                                ...
                                                <Button variant="contained" onClick={updateData(data)}>อัพเดต</Button>
